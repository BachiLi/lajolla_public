...
\begin{enumerate}
    ...
    \item Why is it important to have an unbiased solution for volume rendering? Would it be sensible to have something that is biased but faster? 
\end{enumerate}
% Play with the \lstinline{g} parameter of the Henyey-Greenstein phase function in \lstinline{scenes/volpath_test/hetvol.xml} (the valid range is $(-1, 1)$). How does it change the appearance? Why? 
