...
\caption{Test scenes for our fourth volumetric path tracer.}
\label{fig:volpath4}
\end{figure}
...
\paragraph{Task (12\%).} You will implement the algorithm above in the \lstinline{vol_path_tracing_4} function in \lstinline{vol_path_tracing.h}. Test your rendering using the scenes \lstinline{scenes/volpath_test/volpath_test4.xml} and \lstinline{scenes/volpath_test/volpath_test4_2.xml}. You should get an image that looks like Figure~\ref{fig:volpath4}.
