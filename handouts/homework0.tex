...
Lajolla uses a random number generator called \href{PCG}{https://www.pcg-random.org/} which is a very lightweight random number generator based on simple postprocessing of a standard linear congruent generator. PCG generally has good statistical properties and is much cheaper to compute compared to more advanced RNG, e.g., Merserner Twister. Highly recommend Melissa O'Neill's \href{talk}{https://www.youtube.com/watch?v=45Oet5qjlms} about PCG.
